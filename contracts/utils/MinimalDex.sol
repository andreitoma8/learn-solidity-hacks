...
contract MinimalDex is ERC20 {
    ...
    constructor(address token) ERC20("MinimalDex", "MD") {
     ...
     */
    function removeLiquidity(uint256 poolTokenAmount) public returns (uint256 ethAmount, uint256 tokenAmount) {
